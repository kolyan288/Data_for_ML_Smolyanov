📁 Задание 1 — DataCollectionAgent (15 баллов) Задание 1 — DataCollectionAgent | 15 баллов | Дедлайн: занятие 5 (13.03.2026) ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ ЦЕЛЬ Написать агента, который умеет собирать данные из нескольких источников и возвращает унифицированный датасет. АРХИТЕКТУРА АГЕНТА
...
* skill: merge(sources: list[DataFrame]) → DataFrame ТЕХНИЧЕСКИЙ КОНТРАКТ from data_collection_agent import DataCollectionAgent agent = DataCollectionAgent(config='config.yaml') df = agent.run(sources=[ {'type': 'hf_dataset', 'name': 'imdb'}, {'type': 'scrape', 'url': '...', 'selector': '...'}, ]) → pd.DataFrame со стандартными колонками: text/audio/image, label, source, collected_at ТРЕБОВАНИЯ
...
* requirements.txt или pyproject.toml СТРУКТУРА РЕПОЗИТОРИЯ
...
@ТЕМА@ == недвижимости (аренда и продажа) в Санкт-Петербурге
